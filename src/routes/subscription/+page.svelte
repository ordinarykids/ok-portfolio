<script>
    ...
    async function createPaymentIntent() {
        ...
        const response = await fetch(
            "/examples/payment-request/payment-intent",
            { method: "POST" },
        );
...
<p>
    If you see a blank screen, it's because this demo will only work if the TLD
    is <code>https://localhost</code> or if you're using production keys.
</p>
<p>
...
<nav>
    <a
        href="https://github.com/joshnuss/svelte-stripe/tree/main/src/routes/examples/payment-request"
        >View code</a
    >
</nav>
